  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        const programCardRes = results[8].status === 'fulfilled' ? results[8].value : { success: false, data: [] as ProgramCard[] };
        const settingsRes = results[9].status === 'fulfilled' ? results[9].value : { success: false, data: [] };
