  ...
  if (notFound || !teacher) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 text-slate-500">
        ...
        <p className="text-lg font-black">Teacher not found.</p>
        <Link href="/" className="text-indigo-600 font-bold text-sm hover:underline">← Back to home</Link>
      </div>
    );
  }
