...
function AdminExamNewPageContent() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F6FB]">
      <header className="sticky top-0 z-10 border-b border-slate-200 bg-white/95 py-3 shadow-sm backdrop-blur">
        <div className={`${containerClass} flex flex-wrap items-center justify-between gap-2`}>
...
export default function AdminExamNewPage() {
  return (
    <Suspense fallback={<p className="text-center text-sm text-slate-500 py-12">Loading page…</p>}>
