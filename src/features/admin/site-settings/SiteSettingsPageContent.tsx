...
const DEFAULTS: Record<string, string> = {
  ...
  'courses.title': 'Explore Our ',
  'courses.titleHighlight': 'Most Popular Courses',
  'courses.subtitle': 'Learn Today, Lead Tomorrow',
  'courses.button': 'View All Courses',

  'teachers.badge': 'OUR TEACHERS',
  'teachers.title': 'Meet the Mentors Behind Thousands of Success Stories',

  'library.badge': 'Learning Resource',
  'library.title': 'Knowledge That ',
  'library.titleHighlight': 'Leads to Success',
  'library.button': 'View All Books',

  'payment.badge': 'Secure Checkout',
  'payment.title': 'Payment Partner',
  'payment.subtitle': 'Trusted payment gateways ensuring safe and secure transactions',
  'payment.footer': 'Powered by bKash',

  'programs_cta.label': 'Our Programs',
  'programs_cta.title': 'Learn • Practice • Succeed',
  'programs_cta.button': 'View All Courses',

  'partners.badge': 'TRUSTED BY',
  'partners.title': 'Our Partners',
  'partners.subtitle': 'Institutions and brands we work with — update the list from the admin panel.',

  'trust.title': 'Why MathLab',
  'trust.subtitle': 'Your Pathway to Academic & Admission Success',
  ...
  'navbar.home_href': '/',
  'navbar.link_1_label': 'All Courses', 'navbar.link_1_href': '/courses',
  'navbar.link_2_label': 'Books', 'navbar.link_2_href': '/books',
  'navbar.link_3_label': 'Branches', 'navbar.link_3_href': '/branches',
  'navbar.link_4_label': 'About Us', 'navbar.link_4_href': '/about-us',
  'navbar.link_5_label': '', 'navbar.link_5_href': '#',
  'navbar.link_6_label': '', 'navbar.link_6_href': '#',
  'navbar.login_label': 'Login / Sign Up',
  'navbar.login_href': '/login',
  'navbar.dashboard_label': 'Dashboard',
  'navbar.logout_label': 'Log Out',

  // Footer
  'footer.brand_name': 'Mathlab',
  'footer.description': 'We believe quality education is a right for everyone. Making learning accessible through technology is our core mission.',
  'footer.phone': '+880 1700-000000',
  ...
  'footer.whatsapp': '#',
  'footer.youtube': '#',
  'footer.newsletter_title': 'Want updates on new courses?',
  'footer.newsletter_subtitle': 'Subscribe to our newsletter to stay connected.',
  'footer.newsletter_placeholder': 'Your email...',
  'footer.courses_heading': 'Featured Courses',
  'footer.links_heading': 'Quick Links',
  'footer.contact_heading': 'Contact Us',
  'footer.copyright': '© 2026 Mathlab',
  'footer.payment_logo_url': '/images/collaborator/bikash-logo.png',
  // Courses slots
  'footer.course_1_label': 'Academic Program', 'footer.course_1_href': '/courses',
  'footer.course_2_label': 'Admission Program', 'footer.course_2_href': '/courses',
  'footer.course_3_label': 'Olympiad',           'footer.course_3_href': '/courses',
  'footer.course_4_label': '',                   'footer.course_4_href': '/courses',
  'footer.course_5_label': '',                   'footer.course_5_href': '/courses',
  'footer.course_6_label': '',                   'footer.course_6_href': '/courses',
  // Link slots
  'footer.link_1_label': 'About Us',       'footer.link_1_href': '/about-us',
  'footer.link_2_label': 'Privacy Policy', 'footer.link_2_href': '/privacy-policy',
  'footer.link_3_label': 'FAQ',            'footer.link_3_href': '/faq',
...
export function SiteSettingsPageContent() {
