              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-sm font-semibold text-slate-700">
                    Invoices are expected only within each enrollment&apos;s billing start and end month.
                  </p>
                </div>
                {selectedMonthBillingSummary && (
                  <div className="rounded-xl border border-sky-200 bg-white px-3 py-2 text-right shadow-sm">
                    <p className="text-[10px] font-bold uppercase tracking-wider text-sky-600">Selected Month Coverage</p>
                    <p className="mt-1 text-sm font-black text-slate-900">
                      {selectedMonthBillingSummary.enrollments} enrollment{selectedMonthBillingSummary.enrollments !== 1 ? 's' : ''}
                    </p>
                    <p className="text-xs font-semibold text-slate-500">
                      {selMonth ? fmtMonth(selMonth) : 'No month selected'}
                    </p>
                  </div>
                )}
              </div>
