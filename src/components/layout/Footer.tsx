...
const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  'footer.course_1_label': 'Academic Program',
  'footer.course_1_href': '/courses',
  'footer.course_2_label': 'Admission Program',
  'footer.course_2_href': '/courses',
  'footer.course_3_label': 'Olympiad',
  'footer.course_3_href': '/courses',
  'footer.course_4_label': '',
  ...
  'footer.link_1_label': 'About Us',
  'footer.link_1_href': '/about-us',
  'footer.link_2_label': 'Privacy Policy',
  'footer.link_2_href': '/privacy-policy',
  'footer.link_3_label': 'FAQ',
  'footer.link_3_href': '/faq',
  'footer.link_4_label': '',
  'footer.link_4_href': '#',
  'footer.link_5_label': '',
  'footer.link_5_href': '#',
