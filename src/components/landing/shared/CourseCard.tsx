  ...
  >
    ...
    <div className="relative h-full bg-white rounded-[40px] overflow-hidden flex flex-col transition-all duration-500 group-hover:translate-y-[-8px]">
      ...
      <div className="p-8 flex flex-col flex-1">
        ...
        <Link href={`/course/${course.id}`} className="mt-8 block cursor-pointer">
          <button className="relative w-full group/btn overflow-hidden h-14 rounded-2xl bg-slate-900 transition-all duration-300 cursor-pointer">
